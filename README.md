...
<h1 align="center">Cloudimage Plugins</h1>

<p align="center">
  Open-source JavaScript plugins for interactive media experiences on the modern web.<br>
  Zero dependencies &middot; WCAG 2.1 AA accessible &middot; Framework agnostic
</p>
...
- **Cloudimage CDN** — Native integration with [Cloudimage](https://www.cloudimage.io) for on-the-fly image optimization and global delivery.
...
[MIT](LICENSE) — Made with care by the [Scaleflex](https://www.scaleflex.com) team.
